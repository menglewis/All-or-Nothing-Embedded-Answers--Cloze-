<?php
$string['addingmultianswerset'] = 'Adding All or Nothing Embedded answers (Cloze)';
...
$string['editingmultianswerset'] = 'Editing an All or Nothing Embedded answers (Cloze)';
...
$string['multianswerset'] = 'All or Nothing Embedded answers (Cloze)';
$string['nooptionsforsubquestion'] = 'Unable to get options for question part # $a->sub (question->id={$a->id})';
$string['noquestions'] = 'The All or Nothing Cloze(multianswerset) question \"<strong>$a</strong>\" does not contain any question ';
